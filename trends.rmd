...
frequencies$eu_integratie[frequencies$eu_integration==5] <- "EU integratie te ver"
frequencies$eu_integratie[frequencies$eu_integration==1] <- "EU integratie niet ver genoeg"
...
ggp <- ggplot(dataplot, aes(x=jaar, y=eu_integration, colour= opleiding)) +           # Create basic ggplot
  ...
  #xlim(0,13) +
  #ylim(0,4) + 
  scale_x_continuous(name="jaar", breaks=c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2016, 2017, 2018, 2019, 2020), limits=c(2008,2020)) +
...
ggp <- ggplot(dataplot, aes(x=jaar, y=immigrants, colour= stedelijkheid)) +           # Create basic ggplot
  geom_smooth() + 
  scale_x_continuous(name="jaar", breaks=c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2016, 2017, 2018, 2019, 2020), limits=c(2008,2018)) +
  scale_y_continuous(labels=c("behoud eigen cultuur", "2", "3", "4","volledige assimilatie"), limits = c(1,5)) + 
