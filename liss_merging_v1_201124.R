...
setwd("C:/Users/u399171/surfdrive/Research/PhD project/data/LISS data/original_data/leisure_integ_data")
getwd()

#import the different liss files from their directory. 
file_names=as.list(dir(pattern = '*.sav'))
...
for (i in 1:length(file_names)) {
  liss_files[[i]] <- read_sav(file_names[[i]])
}
...
#order on nomem_encr
liss_merged <- liss_merged[base::order(liss_merged$nomem_encr),]
...
setwd('C:/Users/u399171/surfdrive/Research/PhD project/data/LISS data/original_data/pol_data')
getwd()
...
#name them. 
for (i in 1:length(file_names)) {
  liss_names_alters[[i]] <- read_sav(file_names[[i]])
} 
...
setwd('C:/Users/u399171/surfdrive/Research/PhD project/data/LISS data/original_data/avars')
getwd()
...
#set working directory. 
getwd()
setwd("C:/Users/u399171/surfdrive/Research/PhD project/data/LISS data/created_data/liss_core")


#save RData.
save.image("liss_merged_core_file_v1_201124.Rdata")
