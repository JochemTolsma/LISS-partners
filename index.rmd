...
+#can we estimate stuff quicker. We need this if we add more dependent variables
estimate <- function(x) lavaan(myModel, data=x, missing = "ml", meanstructure = T )
library(future.apply)
plan(multisession)
results <- future_lapply(datalist_ori, estimate)

#this seems to work. 1 model takes 10% of cpu, two models 18%!!
